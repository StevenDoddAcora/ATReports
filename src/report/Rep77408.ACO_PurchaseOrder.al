        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    //>>3.0.10.2018
                    //column(OrderNo_PurchHeader; "Purchase Header"."Vendor Invoice No.")
                    column(OrderNo_PurchHeader; "Purchase Header"."No.")
                    //<<3.0.10.2018
                    {
                    }
                    ...
                    column(YourOrderNo_PurchHeader; "Purchase Header"."Vendor Order No.")
                    {
                    }
                    column(AccountRef_PurchHeader; "Purchase Header"."Buy-from Vendor No.")
                    {
                    }
                    //>>FIX
...
13, "No.", "Doc. No. Occurrence", "No. of Archived Versions", DATABASE::Vendor, "Buy-from Vendor No.",
    ...
    labels
    {
        CustomOrderNoCaptionLbl = 'Order No.';
        CustomOrderDateCaptionLbl = 'Order Date';
        CustomYourOrderNoCaptionLbl = 'Your Order No.';
        CustomAccountRefCaptionLbl = 'Account Ref.';
        CustomQuantityOrderedCaptionLbl = 'Qty. Ordered';
        CustomProductCodeCaptionLbl = 'Product Code';
        CustomSupplierCodeCaptionLbl = 'Supplier Code';
        CustomProductDescriptionCaptionLbl = 'Product Description';
        CustomUnitPriceCaptionLbl = 'Unit Price';
        CustomNetAmountCaptionLbl = 'Net Amount';
        CustomTotalNetCaptionLbl = 'Total Net';
        CustomTotalVATCaptionLbl = 'Total VAT Amount';
        CustomOrderTotalCaptionLbl = 'Order Total';
        CustomDeliveryToCaptionLbl = 'Deliver To:';
        CustomReportTitleCaptionLbl = 'PURCHASE ORDER';
        CustomVATRegNoCaptionLbl = 'VAT Reg. No.';
        CustomNotVATInvoiceCaptionLbl = 'This is not a VAT Invoice';
    }
